...
# Introducing an optional parameter to allow the user to specify the name of the new page
$newPageName = $DestPageName
if ($DestPageName -eq "x") {
    $DestPageName = $"copy-$($PageName)"
}
