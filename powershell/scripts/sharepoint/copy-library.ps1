param (
    ...
    $SourceConn = Connect-PnPOnline -Url $SourceSiteURL -ClientId $PNPAPPID -Tenant $PNPTENANTID -CertificatePath "$PNPCERTIFICATEPATH"  -ReturnConnection
    ...
    Set-PnpTenantSite -Identity $SourceSiteURL -DenyAddAndCustomizePages:$false
    ...
    $DestinationConn = Connect-PnPOnline -Url $DestinationSiteURL -ClientId $PNPAPPID -Tenant $PNPTENANTID -CertificatePath "$PNPCERTIFICATEPATH"  -ReturnConnection
    ...
    Set-PnpTenantSite -Identity $DestinationSiteURL -DenyAddAndCustomizePages:$false
